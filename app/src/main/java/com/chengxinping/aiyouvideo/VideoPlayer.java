...
public class VideoPlayer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            String[] searchKey = new String[]{MediaStore.Video.Media.TITLE, MediaStore.Video.Media.WIDTH, MediaStore.Video.Media.HEIGHT, MediaStore.Video.Media.SIZE, MediaStore.Video.Media.DATE_ADDED};
            ...
            if (cursor != null) {
                if (cursor.getCount() > 0) {
                    ...
                    TextView tittle = (TextView) findViewById(R.id.video_player_title);
                    ...
                    TextView tittle = (TextView) findViewById(R.id.video_player_title);
                    tittle.setText(R.string.unknown);

                    TextView created = (TextView) findViewById(R.id.video_create_time);
                    created.setText(R.string.unknown);

                    TextView screen = (TextView) findViewById(R.id.video_size);
